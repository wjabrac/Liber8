...
from src.service.migrations import list_postgres_migrations, MigrationRunner
...
def _cmd_migrate(args: argparse.Namespace) -> int:
    dsn = args.dsn or os.getenv("LIBR8_POSTGRES_DSN")
    if not dsn:
        print("Error: LIBR8_POSTGRES_DSN not set and --dsn not provided.")
        return 1
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    migrate_parser = subparsers.add_parser("migrate", help="Apply operational PostgreSQL migrations")
    migrate_parser.add_argument("--dsn", default=None, help="PostgreSQL DSN")
